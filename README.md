...
f"{project_name}/game.html": """<!DOCTYPE html>
<html lang="uk">
<head>
<meta charset="UTF-8">
<title>Гра</title>
...
f"{project_name}/css/style.css": """body {
font-family: Arial;
background: #1e3c72;
color: white;
text-align: center;
...
f"{project_name}/js/data.js": """const countries = [
...
f"{project_name}/js/score.js": """let score = 0;
...
f"{project_name}/js/game.js": """let current = 0;
...
print("Проєкт GeoMaster створено!")
